// PLASTIBOT MENDEL
// Extruder
// Changed idler nut traps to accept 6-32 screws
// Closed the holes on the idler tensioning screws
...
////////// RENDER EXTRUDER //////////////////////////////////////////////////////////////
mirror() translate([-20,0,0]) wade(hotend_mount=groovemount, legacy_mount=false);
...
//mirror() translate([-35,45,0])								// POSITIONING
	//bearing_washer();


////////// RENDER IDLER /////////////////////////////////////////////////////////////////////
//mirror() translate([58+extra_gear_separation,-10,16.20])		// POSITIONING
//	rotate([0,-90,0])
//		wadeidler();

////////// RENDER SHAFT /////////////////////////////////////////////////////////////////////
//mirror() translate([-45,25,0])
	//axle_8mm();
...
//%cube([12,4,5],center=true);
	...
	difference(){
		...
		translate(idler_axis+[2+guide_height,+idler_long_side-idler_long_bottom-guide_length/2,0]){
			cube([7,guide_length+2,2.5],center=true);
			translate([-7/2,0,0])
			rotate([90,0,0])
			cylinder(h=guide_length+4,r=2.5/2,center=true,$fn=16);
		}
...
//		rotate([0,0,30])
		...
		translate(idler_axis+[2-idler_height,0,0]){
			...
			rotate([0,90,0]){
				...
				cube([idler_mounting_hole_diameter,idler_mounting_hole_elongation+1,
					idler_height+2]);
			}
