...
int tpuPreheatHotendTemp;
int tpuPreheatHPBTemp;
int tpuPreheatFanSpeed;
...
static void lcd_control_temperature_preheat_tpu_settings_menu();
...
void lcd_preheat_tpu()
{
    setTargetHotend0(tpuPreheatHotendTemp);
    setTargetHotend1(tpuPreheatHotendTemp);
    setTargetHotend2(tpuPreheatHotendTemp);
    setTargetBed(tpuPreheatHPBTemp);
    fanSpeed = tpuPreheatFanSpeed;
...
static void lcd_prepare_menu()
{
    ...
    MENU_ITEM(function, MSG_PREHEAT_TPU, lcd_preheat_tpu);
...
#endif//PIDTEMP
    MENU_ITEM(submenu, MSG_PREHEAT_TPU_SETTINGS, lcd_control_temperature_preheat_tpu_settings_menu);
...
static void lcd_control_temperature_preheat_tpu_settings_menu()
{
    ...
    MENU_ITEM_EDIT(int3, MSG_FAN_SPEED, &tpuPreheatFanSpeed, 0, 255);
    MENU_ITEM_EDIT(int3, MSG_NOZZLE, &tpuPreheatHotendTemp, 0, HEATER_0_MAXTEMP - 15);
#if TEMP_SENSOR_BED != 0
    MENU_ITEM_EDIT(int3, MSG_BED, &tpuPreheatHPBTemp, 0, BED_MAXTEMP - 15);
#endif
#ifdef EEPROM_SETTINGS
    MENU_ITEM(function, MSG_STORE_EPROM, Config_StoreSettings);
#endif
