...
#define CUSTOM_PRINTER_NAME "Plastibot"
...
#ifdef PIDTEMPBED
//12v 150W PCB into 3mm borosilicate
  #define  DEFAULT_bedKp 162.50
  #define  DEFAULT_bedKi 9.88
  #define  DEFAULT_bedKd 668.28
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {44.4444,80.0,2560,856}  // default steps per unit for Plastibot Mendel {X,Y,Z,E}
...
#define EXTRUDER_OFFSET_Y {0.0, 66.20}  // (in mm) for each extruder, offset of the hotend on the Y axis
