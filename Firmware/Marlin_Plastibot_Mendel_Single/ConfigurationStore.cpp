...
void Config_StoreSettings() 
{
  ...
  #endif
  #ifndef ULTIPANEL
  int tpuPreheatHotendTemp = TPU_PREHEAT_HOTEND_TEMP, tpuPreheatHPBTemp = TPU_PREHEAT_HPB_TEMP, tpuPreheatFanSpeed = TPU_PREHEAT_FAN_SPEED;
  ...
  #endif
  EEPROM_WRITE_VAR(i,tpuPreheatHotendTemp);
  EEPROM_WRITE_VAR(i,tpuPreheatHPBTemp);
  EEPROM_WRITE_VAR(i,tpuPreheatFanSpeed);
...
void Config_RetrieveSettings()
{
    ...
    if (strncmp(ver,stored_ver,3) == 0)
    {
        ...
        #endif
        #ifndef ULTIPANEL
        int tpuPreheatHotendTemp, tpuPreheatHPBTemp, tpuPreheatFanSpeed;
        int plaPreheatHotendTemp, plaPreheatHPBTemp, plaPreheatFanSpeed;
        int hipsPreheatHotendTemp, hipsPreheatHPBTemp, hipsPreheatFanSpeed;
        int absPreheatHotendTemp, absPreheatHPBTemp, absPreheatFanSpeed;
        #endif
        EEPROM_READ_VAR(i,tpuPreheatHotendTemp);
        EEPROM_READ_VAR(i,tpuPreheatHPBTemp);
        EEPROM_READ_VAR(i,tpuPreheatFanSpeed);
...
#endif
#ifdef ULTIPANEL
    tpuPreheatHotendTemp = TPU_PREHEAT_HOTEND_TEMP;
    tpuPreheatHPBTemp = TPU_PREHEAT_HPB_TEMP;
    tpuPreheatFanSpeed = TPU_PREHEAT_FAN_SPEED;
