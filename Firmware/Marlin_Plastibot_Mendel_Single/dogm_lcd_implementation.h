...
static void lcd_implementation_init()
{
	...
	do {
			...
			// Plastibot init bmp
			u8g.drawBitmapP(0,0,PLASTIBOT_BMPBYTEWIDTH,PLASTIBOT_BMPHEIGHT,plastibot_bmp);
			// Welcome message
			u8g.setFont(u8g_font_7x13);
			u8g.drawStr(63,14,"PLASTIBOT");
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(73,23,"X16 v1.0");
			u8g.setFont(u8g_font_6x10_marlin);
			u8g.drawStr(63,34,"3D Printer");
			u8g.setFont(u8g_font_5x8);
			u8g.drawStr(63,43,"plastibot.com");
			u8g.setFont(u8g_font_5x8);
